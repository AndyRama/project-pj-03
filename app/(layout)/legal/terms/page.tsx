    ...
    <div className="mx-auto max-w-3xl p-6">
      ...
      <section className="mb-6">
        ...
        <ul className="ml-6 mt-2 list-disc">
          <Typography variant="li">Données de navigation</Typography>
        </ul>
      </section>
      ...
      <section className="mb-6">
        ...
        <ul className="ml-6 mt-2 list-disc">
          <Typography variant="li">Google Analytics : pour mesurer l'audience du site.</Typography>
          <Typography variant="li">Google Tag Manager : pour gérer les balises Google.</Typography>
          <Typography variant="li">Google Adsense : pour les annonces publicitaires.</Typography>
        </ul>
      </section>
