...
export const PricingCard = (props: PricingCardProps) => {
  return (
    <Card
      className={cn(
        "bg-[#2F2E2E] border-[0.5px] flex-1 p-6 ring-1 ring-gray-900/10 sm:p-4 mt-10 w-[330px] rounded-md",
        {
      ...
      <CardHeader className="flex flex-col items-center gap-1">
        ...
        <Link href={props.link} target="_blank" rel="noreferrer" className="mt-20 w-full">
          <Button
            ...
            size="lg"
            className="w-full rounded-[10px] border bg-orange-600 text-base font-bold text-white shadow-md transition-all duration-300 hover:scale-105 hover:border-orange-500 hover:bg-orange-600 hover:shadow-lg"
          >
            {props.cta}
          </Button>
        </Link>
