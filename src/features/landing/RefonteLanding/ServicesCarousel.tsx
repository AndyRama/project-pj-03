  ...
  return (
    <div className="mx-auto w-full max-w-7xl px-4 py-12">
      ...
      <div className="relative mb-12 overflow-hidden">
        ...
        >
          <span className="mr-8 text-6xl font-black text-gray-900">NOS SERVICES</span>
          <span className="mr-8 text-6xl font-black text-red-600">•</span>
          <span className="mr-8 text-6xl font-black text-gray-900">NOS SERVICES</span>
          <span className="mr-8 text-6xl font-black text-red-600">•</span>
          <span className="mr-8 text-6xl font-black text-gray-900">NOS SERVICES</span>
          <span className="mr-8 text-6xl font-black text-red-600">•</span>
      ...
      <div className="relative mb-8 overflow-hidden">
        ...
        >
          {services.concat(services).map((service, index) => (
            ...
            >
              <div className="flex h-80 flex-col items-center rounded-2xl border-2 border-gray-200 bg-white p-8 text-center transition-colors duration-300 hover:border-red-300">
                <div className="mb-6 flex size-16 items-center justify-center rounded-full bg-red-700 text-white">
                  {service.icon}
                </div>
