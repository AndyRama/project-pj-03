...
export const Hero = () => {
  return (
    <main>
      ...
      >
        <div className="relative m-auto mt-16 flex min-h-screen w-full max-w-7xl flex-col items-center gap-8 px-4 pb-12 pt-24 md:min-h-screen md:flex-row md:items-center md:gap-8 md:pt-0 lg:gap-12 lg:px-8">
